--Lt. of the 3nd Division - Izuru Kira
local s,id=GetID()
...
function s.thfilter(c)
	return c:IsSetCard(0x2013) and (c:IsType(TYPE_SPELL) or c:IsType(TYPE_TRAP)) and c:IsAbleToHand() and not Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_HAND,0,1,nil,c:GetCode())
end
