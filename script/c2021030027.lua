...
function s.initial_effect(c)
	...
	local ls0=Effect.CreateEffect(c)
	ls0:SetType(EFFECT_TYPE_FIELD)
	ls0:SetRange(LOCATION_EXTRA)
	ls0:SetCode(EFFECT_EXTRA_MATERIAL)
	ls0:SetProperty(EFFECT_FLAG_PLAYER_TARGET|EFFECT_FLAG_CANNOT_DISABLE|EFFECT_FLAG_SET_AVAILABLE)
	ls0:SetTargetRange(1,1)
	ls0:SetOperation(s.extracon)
	ls0:SetValue(s.extraval)
	c:RegisterEffect(ls0)
