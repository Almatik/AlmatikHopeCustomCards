...
function s.initial_effect(c)
	...
	e2:SetTargetRange(s.indfilter,0)
	c:RegisterEffect(e2)
	local e3=e1:Clone()
	...
	e4:SetTargetRange(s.indfilter,0)
...
function s.indfilter(e,re)
	local c=e:GetHandler()
	local rc=re:GetHandler()
	return rc:IsFaceup() and rc:IsLinkMonster()
		and rc:GetLinkedGroup():IsContains(c)
end
