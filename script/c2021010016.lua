...
function s.initial_effect(c)
	...
	e1c:SetTargetRange(LOCATION_MZONE,LOCATION_MZONE)
	e1c:SetTarget(s.indtarget)
	c:RegisterEffect(e1c)
	local e1d=e1a:Clone()
	e1d:SetType(EFFECT_TYPE_FIELD)
	e1d:SetCode(EFFECT_IMMUNE_EFFECT)
	e1d:SetTargetRange(LOCATION_MZONE,LOCATION_MZONE)
	e1d:SetTarget(s.indtarget)
	e1d:SetValue(s.efilter)
