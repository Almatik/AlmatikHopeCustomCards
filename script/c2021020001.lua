...
function s.getop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetTurnCount()==1
		...
		or Duel.GetTurnCount()==37 then
		if Duel.GetTurnPlayer()==tp then
			Duel.RegisterFlagEffect(tp,id+1,0,RESET_PHASE+PHASE_END,5,Duel.GetLP(1-tp))
		else
			Duel.RegisterFlagEffect(tp,id+1,0,RESET_PHASE+PHASE_END,5,Duel.GetLP(tp))
		end
	end
	--Player Two
	if Duel.GetTurnCount()==2
		...
		if Duel.GetTurnPlayer()==tp then
			...
			Duel.RegisterFlagEffect(tp,id+2,0,RESET_PHASE+PHASE_END,5,Duel.GetLP(1-tp))
		else
			Duel.ResetFlagEffect(tp,id+2)
			Duel.RegisterFlagEffect(tp,id+2,0,RESET_PHASE+PHASE_END,5,Duel.GetLP(tp))
		end
	end
	--Player Three
	if Duel.GetTurnCount()==3
		...
		if Duel.GetTurnPlayer()==tp then
			...
			Duel.RegisterFlagEffect(tp,id+3,0,RESET_PHASE+PHASE_END,5,Duel.GetLP(1-tp))
		else
			Duel.ResetFlagEffect(tp,id+3)
			Duel.RegisterFlagEffect(tp,id+3,0,RESET_PHASE+PHASE_END,5,Duel.GetLP(tp))
		end
	end
	--Player Four
	if Duel.GetTurnCount()==4
		...
		if Duel.GetTurnPlayer()==tp then
			...
			Duel.RegisterFlagEffect(tp,id+4,0,RESET_PHASE+PHASE_END,5,Duel.GetLP(1-tp))
		else
			Duel.ResetFlagEffect(tp,id+4)
			Duel.RegisterFlagEffect(tp,id+4,0,RESET_PHASE+PHASE_END,5,Duel.GetLP(tp))
		end
	end
end