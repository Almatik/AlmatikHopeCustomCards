...
function s.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.RegisterFlagEffect(tp,id+1,RESET_PHASE+PHASE_END,0,0)*lp
	Duel.RegisterFlagEffect(tp,id+2,RESET_PHASE+PHASE_END,0,0)*lp
	Duel.RegisterFlagEffect(tp,id+3,RESET_PHASE+PHASE_END,0,0)*lp
	Duel.RegisterFlagEffect(tp,id+4,RESET_PHASE+PHASE_END,0,0)*lp
end
